...
logger = sken_logger.get_logger("pytorch_face_detection")
    ...
    def run(self, file_path):
        ...
        while True:
            ...
            try:
                ...
                boxes = self.model.detectMultiScale(frame, 1.1, 4)
                # face_encodings = face_recognition.face_encodings(frame[:, :, ::-1], boxes)
                # video.put_detected_face_encodings(objects.DetectedFaces(face_encodings))
...
if __name__ == '__main__':
    ...
    s = time.time()
    fcd.run("/home/andy/Downloads/7_tEmd7Zuw_EKqK.mp4")
